...
{
    [TestFixture]
    public class AlphabeticAscendentSorterTest
    {
        [TestCase("Take a piece of advice", "a")]
        [TestCase("Take A piece of advice", "A")]
        public void Sort_WithSpaceWordDelimiter_FirstWordHasLetter_A(string textQuery,string expectingWord)
        {
            //Arrange
            ITextSorter alphabeticSorter = new AlphabeticAscendentSorter();
        ...
        [TestCase("I like movie World War z", "z")]
        public void Sort_WithSpaceWordDelimiter_LastWordHasLetter_Z(string textQuery, string expectingWord)
        {
            //Arrange
            ITextSorter alphabeticSorter = new AlphabeticAscendentSorter();
